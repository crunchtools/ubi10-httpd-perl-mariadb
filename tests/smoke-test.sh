#!/bin/bash
# smoke-test.sh — smoke tests for ubi10-httpd-perl-mariadb container image
...
# ---------- Inherited (ubi10-httpd-perl) ----------
echo "=== Inherited (ubi10-httpd-perl) ==="

INHERITED_PACKAGES=(httpd mod_fcgid perl)
